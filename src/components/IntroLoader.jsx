        ...
        >
          <div className="mb-5 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-mono text-[0.78rem] text-white/82 sm:text-[0.92rem]">aman@portfolio:~$</p>
                <p className="mt-1 text-[0.56rem] uppercase tracking-[0.22em] text-white/38 sm:text-[0.62rem]">
                  launch sequence active
                </p>
              </div>
            </div>
            <div className="inline-flex items-center rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[0.56rem] uppercase tracking-[0.2em] text-white/48 sm:text-[0.62rem]">
              ESC to skip
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(135deg,rgba(6,10,22,0.78),rgba(3,6,16,0.68))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-[18px] sm:p-7">
            ...
            <div className="relative">
              <p className="font-mono text-[0.58rem] uppercase tracking-[0.28em] text-brand-soft/90 sm:text-[0.68rem]">
              ...
              <h1 className="mt-3 max-w-2xl font-display text-[1.8rem] font-semibold leading-[0.98] tracking-[0.03em] text-white sm:text-[2.6rem]">
                Building a cleaner
                <span className="block bg-[linear-gradient(90deg,#ff9f5a,#ffffff,#56a4ff)] bg-clip-text text-transparent">
              ...
              <div className="mt-6 space-y-3 font-mono text-[0.74rem] sm:text-[0.9rem]">
                {[
                  ...
                  >
                    ...
                    <span className={index === 2 ? "text-white" : "text-white/58"}>
                      {line}
                      {index === 2 ? (
                        <motion.span
              ...
              >
                <div className="mb-2.5 flex items-center justify-between font-mono text-[0.62rem] uppercase tracking-[0.18em] text-white/55 sm:text-[0.72rem]">
                  <span>Progress</span>
                  <span className="text-white/40">81%</span>
                </div>
              ...
              >
                {[
                  ...
                  >
                    <p className="font-mono text-[0.52rem] uppercase tracking-[0.16em] text-white/42 sm:text-[0.58rem]">
                      {item.label}
                    </p>
                    <p className="mt-2 font-mono text-sm text-white/86 sm:text-lg">{item.value}</p>
                  </div>
                ))}
              </motion.div>
              ...
              >
                <div className="rounded-full border border-brand/24 bg-brand/10 px-3 py-1.5 text-[0.56rem] uppercase tracking-[0.18em] text-brand-soft">
                  Premium portfolio boot
                </div>
                <div className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 text-[0.56rem] uppercase tracking-[0.18em] text-white/45">
                  Frontend + backend + AI
                </div>
              </motion.div>
            </div>
