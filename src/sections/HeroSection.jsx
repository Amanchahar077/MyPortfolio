    ...
    <section id="hero" className="relative pt-14 sm:pt-20">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 pb-24 pt-12 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-16 lg:pb-32">
        <div className="relative">
          ...
          />
          <div className="relative">
            <div className="mb-6 inline-flex rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.35em] text-brand-soft">
              {data.theme}
            </div>
            <h1 className="font-display text-5xl font-semibold leading-[0.95] tracking-tight text-white sm:text-6xl lg:text-7xl">
              {data.name}
            </h1>
            <div className="mt-5 min-h-[40px] text-xl font-medium text-white/80 sm:text-2xl">
        ...
        <div className="relative">
          <GlassCard className="relative overflow-hidden rounded-[36px] p-6 sm:p-8">
