...
export function ClosingSection({ data }) {
  return (
    <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:pb-28">
      <GlassCard className="relative overflow-hidden rounded-[40px] px-6 py-8 sm:px-8 sm:py-10 lg:px-12 lg:py-12">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="grid gap-4">
            {data.pillars.map((pillar) => (
              <div key={pillar} className="rounded-[28px] border border-white/10 bg-black/20 p-5 text-white/72">
                {pillar}
              </div>
            ))}
          </div>
